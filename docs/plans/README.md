...
| # | 计划 | 仓库 | 状态 | 前置 |
|---|------|------|------|------|
| 1 | [iOS 语音识别 Spike](2026-07-25-ios-speech-spike.md) — SFSpeechRecognizer 中式口音真机验证 | englishwords | 待执行 | 无（最大技术不确定点，最先做） |
| 2 | [后端词汇模块](2026-07-25-backend-vocab-module.md) — 队列/SRS/幂等提交/统计/例句富化 | senior-platform | 待执行 | 无（与 #1 并行） |
